...
import '../../ViewModels/recruiter//DetailJobViewModel.dart';
...
class DetailJobView extends StatelessWidget {
  ...
  const DetailJobView({super.key, required this.jobId});
      ...
      child: Consumer< DetailJobViewModel>(
        builder: (context, viewModel, child) {
          ...
          if (viewModel.error != null) {
            return _buildScaffold(
              context,
              Center(child: Text(viewModel.error!, style: TextStyle(fontFamily: 'Poppins'),)),
            );
          }
  ...
  Scaffold _buildScaffold(BuildContext context, Widget body) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Chi tiết công việc", style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w500),),
        centerTitle: true,
  ...
  Widget _buildBulletItem(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text("• ", style: TextStyle(fontSize: 14, fontFamily: 'Poppins')),
          Expanded(
            child: Text(text, style: const TextStyle(fontSize: 14, fontFamily: 'Poppins')),
          ),
        ],
      ),
    );
  ...
  Widget _buildTag(String text) {
    return Container(
      ...
      child: Text(
        text,
        style: const TextStyle(fontSize: 12, color: Color(0xFF374151), fontFamily: 'Poppins'),
      ),
    );
  }
