...
class _EditJobScreenState extends State<EditJobScreen> {
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: (viewModel.recruiter.Company.LogoUrl != null)
                              ? Image.network(
                  ...
                  titleinJD(title: 'Thông tin mô tả',),
                  customTextField(
                            ...
                            child: Text.rich(
                              ...
                              TextSpan(
                                children: <TextSpan>[
                                  ...
                                  TextSpan(
                                    text: viewModel.recruiter.CompanyLocations
                                        .Address,
                                    style: TextStyle(fontSize: 14,),
                                  ),
                                ],
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: 15,
                              color: (viewModel.selectedDate == null) ? Colors
                                  .grey : Colors.black,
                            ),
  ...
  Container customTextField({required String? hintText,required double height, required TextEditingController controller,TextInputType textInputType = TextInputType.multiline, Function(String)? change, required BuildContext context, List<TextInputFormatter>? format}) {
    return Container(
      height: height,
      padding: EdgeInsets.symmetric(horizontal: 10),
